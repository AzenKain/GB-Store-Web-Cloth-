...
import { getCartDetailApi, getUserDetailApi, makeRequestApi } from "@/lib/api";
                ...
                <ul className="menu menu-horizontal px-1">
                    ...
                    <li>
                        <Link
                            href={{
                                pathname: '/search',
                                query: { category: ['new-arrival'] },
                            }}>
                            NEW ARRIVAL
                        </Link>
                    </li>
                    <li><Link href={"/search/hot-sales"}></Link></li>
                    <li><Link href={"/search/new-arrival"}></Link></li>
                </ul>
            </div>
                ...
                <div className="dropdown dropdown-end">
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
                        <div className="indicator">
                            ...
                            <span className="badge badge-sm indicator-item">{dataCart.items.length}</span>
                        </div>
                    </div>
                    <div tabIndex={0} className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow">
                        <div className="card-body">
                            <span className="font-bold text-lg">{dataCart.items.length} Items</span>
                            <span className="text-info">Subtotal: {dataCart.totalPrice}đ</span>
                    ...
                    <div className="dropdown dropdown-end">
                        <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                            <div className="w-10 rounded-full">
                                <img alt="User" src={dataUser.imgDisplay} />
                            </div>
                        </div>
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
