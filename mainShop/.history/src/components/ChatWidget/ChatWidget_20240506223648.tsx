...
export default function ChatWidget() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
          try {
            const responseData: RoomchatType = await makeRequestApi(getRoomchatUserApi session?.userId, session?.refresh_token, session?.access_token);
            setDataRoomChat(responseData);
            setDataChat(responseData.messages)
