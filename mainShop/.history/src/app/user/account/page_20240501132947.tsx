...
import { editProductApi, editUserDetailApi, getUserDetailApi, makeRequestApi } from "@/lib/api";
...
export default function User() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      let dataUser : UserType = await makeRequestApi(getUserDetailApi, null, session?.expires, session?.access_token)
  ...
  return (
    <div className="my-4 mt-20 max-w-screen-md border px-4 shadow-xl sm:mx-4 sm:rounded-xl sm:px-4 sm:py-4 md:mx-auto">
      <div className="flex flex-col border-b py-4 sm:flex-row sm:items-start">
        ...
        <button onClick={handleSave} className="hidden rounded-lg border-2 border-transparent bg-blue-600 px-4 py-2 font-medium text-white sm:inline focus:outline-none focus:ring hover:bg-blue-700">
          Save
        </button>
      </div>
      <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
        ...
        <input
          ...
          className="input input-bordered w-full rounded-md border bg-white px-2 py-2 outline-none ring-blue-600 focus:ring-1"
        />
      </div>
      <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
      ...
      <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
        <p className="shrink-0 w-32 font-medium">Birthday</p>
      ...
      <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
        ...
        <div className="flex items-center">
          ...
          <label
            htmlFor="Male"
            className="ml-2 flex gap-2 cursor-pointer"
          >
            Male
          </label>
        </div>
      ...
      <div className="flex justify-end py-4 sm:hidden">
        ...
        <button onClick={handleSave} className="rounded-lg border-2 border-transparent bg-blue-600 px-4 py-2 font-medium text-white focus:outline-none focus:ring hover:bg-blue-700">
          Save
        </button>
      </div>
    </div>
