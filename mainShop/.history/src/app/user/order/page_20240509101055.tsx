    ...
    return (
        <div className="py-24 relative">
            <div role="tablist" className="tabs tabs-bordered">
                <button 
                    onClick={() => {
                        ...
                        dispatch(AddFilterOrder("All singles"))
                    }} 
                    role="tab" 
                ...
                <button 
                    onClick={() => {
                        ...
                        dispatch(AddFilterOrder("Processing"))
                    }} 
                    role="tab" 
                ...
                <button 
                    onClick={() => {
                        ...
                        dispatch(AddFilterOrder("In transit"))
                    }}  
                    role="tab" 
                ...
                <button 
                    onClick={() => {
                        setFilter("Delivered")
                        dispatch(AddFilterOrder("Delivered"))
                    }} 
                    role="tab" 
                ...
                <button 
                    onClick={() => {
                        setFilter("Cancelled")
                        dispatch(AddFilterOrder("Cancelled"))
                    }} 
                    role="tab" 
            ...
            <label className="my-4 input input-bordered flex items-center w-full max-w-[26rem] sm:max-w-[36rem] lg:max-w-[77rem] mx-auto">
                <input onChange={e => setSearch(e.target.va)} value={search} type="text" className="grow" placeholder="Search" />
