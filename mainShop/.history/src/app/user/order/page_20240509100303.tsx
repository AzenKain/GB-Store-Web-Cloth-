"use client"
import { AddFilterOrder, AddListOrder } from "@/app/redux/features/order/order.redux";
import { useAppDispatch, useAppSelector } from "@/app/redux/hooks";
import { createVnpayApi, getOrderUserApi, getProductByIdApi, makeRequestApi } from "@/lib/api";
    ...
    return (
        <div className="py-24 relative">
            <div role="tablist" className="tabs tabs-bordered">
                <button onClick={() => {dispatch(AddFilterOrder(filter))}} role="tab" className={`tab ${filter == ""}tab-active`}>All singles</button>
                <button role="tab" className={"tab tab-active"}>Processing</button>
                <button role="tab" className="tab">In transit</button>
                <button role="tab" className="tab">Delivered</button>
                <button role="tab" className="tab">Cancelled</button>
            </div>
