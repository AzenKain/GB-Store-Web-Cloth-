...
import { getOrderUserApi, makeRequestApi } from "@/lib/api";
...
export default function User() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            let dataOrder: OrderType = await makeRequestApi(getOrderUserApi, params.orderId, session?.refresh_token, session?.access_token)
