...
export default function Search() {
    ...
    useEffect(() => {
        ...
        for (let i = 0; i < filters.length; i++) {
            ...
            if (listValue.length > 0) {
                ...
                setBannerDisplay(banner[listValue[0]])
                isSet = true;
            }
        }
        if (isSet == false) {
    ...
    }, [searchParams, filterChanged, dispatch]);
        ...
        <div className="bg-white">
            <div>
                ...
                <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-rows-2 sm:grid-rows-1 grid-flow-col justify-between border-b border-gray-200 pb-6 pt-12 gap-2">
