...
export default function Search() {
    const filter = useAppSelector((state) => state.ProductRedux.value)
    ...
    const handleColorFilterChange = (value: string) => {
        if (colorFilters.includes(value)) {
            setColorFilters(colorFilters.filter(filter => filter !== value));
        } else {
    ...
    const handleBrandFilterChange = (value: string) => {
        if (brandFilters.includes(value)) {
                                                                    ...
                                                                    onChange={() => {
                                                                        ...
                                                                        switch (section.id) {
                                                                            case 'category':
                                                                                ...
                                                                                break;
                                                                            case 'color':
                                                                                handleColorFilterChange(option.value);
                                                                                break;
                                                                            case 'size':
                                                                                handleSizeFilterChange(option.value);
                                                                                break;
                                                                            case 'brand':
