...
export default function Search() {
    ...
    useEffect(() => {
        ...
        let isSet = false;
        let newFilter : FilterSection[] = [...filters]
        for (let i = 0; i < filters.length; i++) {
            ...
            for (let j = 0; j < listValue.length; j++) {
                ...
                let tmpIdex = newFilter[i].options.findIndex(option => option.value === listValue[j]);
                
                if (tmpIdex == -1) continue;
                console.log(newFilter[i].options[tmpIdex])
                newFilter[i].options[tmpIndex] = { ...newFilter[i].options[tmpIndex], checked: true };
            }
