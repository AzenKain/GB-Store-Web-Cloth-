...
const banner = [
    { value: 'men', src: './image/cover/men.jpg' },
    { value: 'women', src: './image/cover/women.jpg' },
    { value: 'Accessories', src: './image/cover/phu-kien.jpg' },
    { value: 'hot-sales', src: './image/cover/best-seller.jpg' },
    { value: 'new-arrival', src: './image/cover/new-arrivals.jpg' },
]
...
export default function Search(prop: any) {
    ...
    const [bannerDisplay, setBannerDisplay] = useState<string | null>()
