...
type Prop = {
    param: { [key: string]: string | string[] }; // Kiểu dữ liệu của param
    searchParam: { [key: string]: string | string[] }; // Kiểu dữ liệu của searchParam
}
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            for (let param in prop.searchParams) {
                ...
                for (let value in prop.searchParams[param]) {
                    dispatch(updateFilter({ id: param, value: prop.searchParams[param][value], checked: true }))
                }
