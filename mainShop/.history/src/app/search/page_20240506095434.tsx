    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            for (let param in prop.searchParams) {
                ...
                const paramValueString: string = paramValueArray.join(', '); 
                ...
                console.log(prop.searchParams[param])
                if (typeof prop.searchParams[param] === "string" && prop.searchParams[param] in banner) {
