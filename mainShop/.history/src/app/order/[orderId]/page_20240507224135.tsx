        ...
        <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
          ...
          <div className="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
            <div className="flex flex-col lg:flex-row lg:items-center justify-between px-6 pb-6 border-b border-gray-200">
              ...
              <button className="rounded-full py-3 px-7 font-semibold text-sm leading-7 text-white bg-indigo-600 max-lg:mt-5 shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-400">Track
                Your Order</button>
            </div>
            ...
            <div className="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
              ...
              <div className="grid grid-cols-2 gap-4">
                <p className="font-semibold text-lg text-black py-6">SubTitle: <span className="text-indigo-600"> $200.00</span></p>
                <p className="font-semibold text-lg text-black py-6">Shipping: <span className="text-indigo-600"> $200.00</span></p>
                <p className="font-semibold text-lg text-black py-6">Tax: <span className="text-indigo-600"> $200.00</span></p>
