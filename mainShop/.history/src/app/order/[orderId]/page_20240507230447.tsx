...
export default function Order({ params }: { params: { orderId: string } }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            let dataOrder: OrderType = await makeRequestApi(getOrderByIdApi, params, session?.refresh_token, session?.access_token)
            ...
            <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
                ...
                <div className="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between px-6 pb-6 border-b border-gray-200">
                        ...
                        <div className="text-3xl font-bold border-4 bg-green-300 p-2 rounded-full">
                            Paid
                        </div>
                    </div>
