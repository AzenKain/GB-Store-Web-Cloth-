        ...
        <div className="py-24 relative">
            ...
            <dialog id="my_modal_3" className="modal">
                <div className="modal-box">
                    ...
                    <div className="text-3xl font-bold text-red-500 p-4">
                        Do you want cancel this order?
                    </div>
                    <div className="w-full text-end">
                        <button 
                            onClick={async () => await handleCancel()}
                            className="btn btn-success w-20 text-lg"
                        >
                            Yes
                        </button>
                        <button 
                            onClick={() =>                                     const modal = document.getElementById('my_modal_3') as HTMLDialogElement | null;
                            if (modal) {
                              modal.showModal();
                            }}
                            className="btn btn-error w-20 text-lg ml-4"
                        >
                            No
                        </button>
                    </div>
