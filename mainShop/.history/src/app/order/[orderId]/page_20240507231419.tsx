...
import { getOrderByIdApi, makeRequestApi } from "@/lib/api";
                ...
                <div className="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between px-6 pb-6 border-b border-gray-200">
                        <div className="data">
                            ...
                            <p className="font-semibold text-base leading-7 text-black mt-4">Order Payment : <span className="text-gray-400 font-medium">{new Date(orderData?.createdAt).toISOString()}</span></p>
                        </div>
                        <div className="text-center text-3xl font-bold border-4 bg-green-300 px-4 py-2 rounded-full">
                            Paid
                        </div>
                    </div>
                    ...
                    <div className="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
                        <div className="flex flex-col sm:flex-row items-center max-lg:border-b border-gray-200">
                            ...
                            <p className="font-medium text-lg text-gray-900 pl-6 py-3 max-lg:text-center">Payment method: <span className="text-gray-500">{"VNPAY"}</span></p>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            <p className="font-semibold text-lg text-black py-6">Shipping: <span className="text-indigo-600"> $200.00</span></p>
