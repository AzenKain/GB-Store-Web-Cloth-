...
import { getOrderByIdApi, getProductByIdApi, makeRequestApi } from "@/lib/api";
            ...
            <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
                ...
                <div className="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                    ...
                    <div className="w-full px-3 min-[400px]:px-6">
                        {orderData.listProducts.((product, index) => (
  <div key={} className="flex flex-col lg:flex-row items-center py-6 border-b border-gray-200 gap-6 w-full">
