"use client";
import { AddProductToCart } from "@/app/redux/features/cart/cart.redux";
...
export default function Product({ params }: { params: { productId: string } }) {
    ...
    const handleAddToCart = () => {
        dispatch(AddProductToCart({productId: productData?.id, quantity: quantityProduct, color: selectedColor}))
    }
