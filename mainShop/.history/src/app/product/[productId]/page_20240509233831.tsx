                ...
                <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div 
                            className="mt-5 cursor-pointer flex gap-2 w-52" onClick={() => document.getElementById('my_modal_3').showModal()}
                            >
                        ...
                        <div className="flex flex-wrap gap-4">
                            <div className="flex w-full">
                                <button
                                    onClick={() => setQuantityProduct(pre => pre -= 1)}
                                ...
                                <button
                                    onClick={async () => await handleUpdateHeart(productData?.id ?? "", !user?.heart.includes(productData?.id ?? ""))}
                                    className="ml-2 group transition-all duration-500 p-4 rounded-full bg-indigo-50 hover:bg-indigo-100 hover:shadow-sm hover:shadow-indigo-300"
                                >
                                    {user?.heart.includes(productData?.id ?? "") ? (
