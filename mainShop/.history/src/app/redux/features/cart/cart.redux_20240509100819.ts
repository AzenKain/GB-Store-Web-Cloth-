...
export const CartRedux = createSlice({
    ...
    reducers: {
        ...
        UpdateMethodCart: (state, action: PayloadAction<string>) => {
            state.method = action.payload;
        },
        UpdateProductCart: (state, action: PayloadAction<ICartItem>) => {
...
export const { UpdateProductCart, AddDataCart, UpdateMethodCart } = CartRedux.actions;
