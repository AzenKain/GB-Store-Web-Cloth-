import { FilterSection, FilterUpdate } from '@/types/fillter';
...
export const CartRedux = createSlice({
    ...
    reducers: {
        updateFilter: (state, action: PayloadAction<FilterUpdate>) => {
            ...
            let newFillter = [...initialState.value];
            newFillter[indexValue].options[indexOption].checked = action.payload.checked;
            return {
                value: newFillter
