    ...
    <main>
      <div className="relative h-[580px] my-6">
        ...
        <div className="absolute inset-x-0 bottom-10 text-center text-white pb-12">
          <div className="text-2xl text-white font-light">
            ...
            <div className="mt-4">
              <button className="btn mr-2 bg-white text-black hover:bg-gray-200 hover:text-black text-base">SHOP MEN</button>
              <button className="btn bg-white text-black hover:bg-gray-200 hover:text-black text-base">SHOP WOMEN</button>
            </div>
        </div>
      </div>

      <div className="p-5 rounded mt-3 text-center my-2">
        <h3 className="bestseller text-3xl font-[350] mb-2">BESTSELLER</h3>
      ...
      <div className="relative h-[580px] my-6">
        ...
        <div className="absolute inset-x-0 bottom-10 text-center text-white pb-12">
          ...
          <div className="mt-4">
            <button className="btn bg-white text-black hover:bg-gray-200 hover:text-black text-base">SHOP NOW</button>
          </div>
        </div>
      </div>
