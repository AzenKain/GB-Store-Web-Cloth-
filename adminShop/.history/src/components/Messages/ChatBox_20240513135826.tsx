  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        setUserData(responseUser.find(it => it.id === responseRoom[0].userId) ?? null)
        console.log(responseUser.find(it => it.id === responseRoom[0].userId))
      } catch (error) {
              ...
              <div className="flex items-center">
                <div className="mr-4.5 h-13 w-full max-w-13 overflow-hidden rounded-full">
                  <Image
                    width={52}
                    height={52}
                    src={userList.find(it => it.id == itemsShow?.userId)?.imgDisplay ?? ""}
                    className="rounded-full"
                    alt="User"
                    style={{
                      width: "auto",
                ...
                <div>
                  <h5 className="font-medium text-black dark:text-white">
                    {userList.find(it => it.id == itemsShow?.userId)?.username}
                  </h5>
