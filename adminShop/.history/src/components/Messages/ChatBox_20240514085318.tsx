          ...
          <div className="hidden h-full flex-col xl:flex xl:w-1/4">
            ...
            <div className="flex max-h-full flex-col overflow-auto p-5">
              <div className="sticky mb-7">
                <input 
                  type="text" className="w-full rounded border border-stroke bg-gray-2 py-2.5 pl-5 pr-10 text-sm outline-none focus:border-primary dark:border-strokedark dark:bg-boxdark-2" placeholder="Search..." typeof="text" />
