  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        dispatch(AddListUser(responseUser))
              ...
              <div className="no-scrollbar max-h-full space-y-2.5 overflow-auto">
                <div className="flex cursor-pointer items-center rounded px-4 py-2 hover:bg-gray-2 dark:hover:bg-strokedark">
                  <div className="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
                    ...
                    />
                    <span
                      className={`absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-gray-2 bg-success${chatData[0].dot === 6 ? "bg-meta-6" : `bg-meta-${chatData[0].dot}`
                        } `}
                    ></span>
                  </div>
                ...
                <div className="flex cursor-pointer items-center rounded px-4 py-2 hover:bg-gray-2 dark:hover:bg-strokedark">
                  <div className="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
                    ...
                    />
                    <span
                      className={`absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-gray-2 bg-success${chatData[1].dot === 6 ? "bg-meta-6" : `bg-meta-${chatData[0].dot}`
                        } `}
                    ></span>
                  </div>
                  <div className="w-full">
