              ...
              onChange={e => {
                setItemsShow(prevItems => {
                  if (e.target.checked) {
                    ...
                    // Initialize role array if it's not already initialized
                    if (!newItems.role) {
                      newItems.role = [];
                    }
                    // Add "BANNED" to the role array
                    newItems.role.push("BANNED");
                    return newItems;
                  } else {
                    // If the item is unchecked, remove "BANNED" from the role array (if it exists)
                    if (prevItems.role) {
