      ...
      <dialog id="my_modal_edit" className="modal modal-bottom sm:modal-middle">
        ...
        <div className="form-control w-65">
          <label className="cursor-pointer label">
            ...
            <input onChange={e => console.log(e.target.checked)} type="checkbox" className="toggle toggle-secondary" checked={false}/>
          </label>
        </div>
        <div className="form-control w-65">
          <label className="cursor-pointer label">
            <span className="label-text">onChange={e => console.log(e.target.value)}</span> 
            <input type="checkbox" className="toggle toggle-accent" checked={itemsShow?.role?.includes("")} />
          </label>
        </div>
      </div>
          <div className="modal-action">
