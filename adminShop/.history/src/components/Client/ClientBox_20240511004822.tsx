      ...
      <dialog id="my_modal_edit" className="modal modal-bottom sm:modal-middle">
        ...
        <div className="form-control w-65">
          <label className="cursor-pointer label">
            ...
            <input type="checkbox" className="toggle toggle-primary" checked={itemsShow?.role?.includes("TWEREHOUSE MANGER")}/>
          </label>
        </div>
        <div className="form-control w-65">
          <label className="cursor-pointer label">
            <span className="label-text">TELESALES</span> 
            <input onChange={e => console.log(e.target.checked)} type="checkbox" className="toggle toggle-secondary" checked={itemsShow?.role?.includes("TELESALES")}/>
          </label>
        </div>
        <div className="form-control w-65">
          <label className="cursor-pointer label">
            <span className="label-text">BANED</span> 
            <input type="checkbox" className="toggle toggle-accent" checked={itemsShow?.role?.includes("BANED")} />
          </label>
        </div>
      </div>
          <div className="modal-action">
