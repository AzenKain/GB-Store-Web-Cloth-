    ...
    return (
        <div className="flex flex-col gap-10">
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div  className="">
                    <div>
                        <div className="mb-8 flex flex-wrap items-center justify-end gap-3.5 px-4 pt-4 sm:px-6 sm:pt-6 xl:px-9">
                        ...
                        <div ref={contentToPrint} className="p-4 sm:p-6 xl:p-9">
                            ...
                            <div className="my-10 gap-1 rounded-sm border border-stroke p-5 dark:border-strokedark">
                                ...
                                <div className="items-center sm:flex gap-0">
                                    <div className="mb-3 mr-6 h-20 w-20 sm:mb-0">
                                        <Image
                                            width={80}
                                            height={80}
                                            src={"https://nextjs-demo.tailadmin.com/_next/image?url=%2Fimages%2Fproduct%2Fproduct-thumb.png&w=96&q=75"}
                                            alt="product"
                                            style={{
                                                width: "auto",
                                                height: "auto",
