...
interface InvoiceCardProps {
    ...
    userShow: UserType | null;
  }

const InvoiceCard : React.FC<InvoiceCardProps> = ({ itemsShow, dataItems, userShow }) => {
                            ...
                            <div className="flex flex-col-reverse gap-5 xl:flex-row xl:justify-between">
                                <div className="flex flex-col gap-4 sm:flex-row xl:gap-9">
                                    <div>
                                        ...
                                        <h4 className="mb-4 text-title-sm2 font-medium leading-[30px] text-black dark:text-white">Item</h4>
                                        ...
                                        <span className="mt-2 block">
                                            ...
                                            Kim giang, Dai Kim, Hoang Mai, Thanh Xuan, Ha Noi.
                                        </span>
                                    </div>
                                    <div>
