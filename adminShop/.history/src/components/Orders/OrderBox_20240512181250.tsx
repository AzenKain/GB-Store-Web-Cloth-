                        ...
                        <div className="">
                            ...
                            <div className="relative z-20 bg-transparent dark:bg-form-input">
                                <select
                                    ...
                                    className={`relative z-20 w-full appearance-none rounded border border-stroke bg-transparent px-5 py-3 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary ${Or? "text-black dark:text-white" : ""
                                        }`}
                                >
