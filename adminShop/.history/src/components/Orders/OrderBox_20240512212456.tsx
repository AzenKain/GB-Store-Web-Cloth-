            ...
            <form className="flex flex-col md:flex-row gap-3">
                <div className="flex w-full">
                    <input
                        ...
                        className="w-full  px-3 h-10 rounded-l border-2 border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark"
                    />
                    <button
                        type="submit"
                ...
                <select
                    id="pricingType"
                    name="pricingType"
                    className="h-10 border-2 border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark rounded px-2 md:px-3 py-0 md:py-1 tracking-wider"
                >
