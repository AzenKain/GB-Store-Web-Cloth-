            ...
            <form className="flex flex-col md:flex-row gap-3">
                <div className="flex w-full">
                    <input
                        ...
                        className="w-full first-letter:text-black dark:text-white  px-3 h-10 rounded-l border-2 border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark"
                    />
                    <button
                        type="submit"
