                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="form-control w-65">
                            <label className="cursor-pointer label">
                                <span className="label-text">IsPaid</span>
                                <input
                                    onChange={e => {
                                        let newItem: OrderType = { ...(itemsShow || {}) }; // Initialize newItem with an empty object if itemsShow is undefined
                                        newItem.userId = e.target.value; // Assuming e.target.value contains the new value for userId
                                        setItemsShow(newItem);
                                    }}
                                    type="checkbox"
