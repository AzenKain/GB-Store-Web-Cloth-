            ...
            <dialog id="my_modal_edit" className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    ...
                    <div className="flex flex-col">
                        <h3 className="font-semibold text-3xl mt-2">Edit Order</h3>
                        ...
                        <div className="">
                            ...
                            <div className="relative z-20 bg-transparent dark:bg-form-input">
                                <select
                                    ...
                                    className={`relative z-20 w-full appearance-none rounded border border-stroke bg-transparent px-5 py-3 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary ${orderStatus? "label-text text-xl" : ""
                                        }`}
                                >
