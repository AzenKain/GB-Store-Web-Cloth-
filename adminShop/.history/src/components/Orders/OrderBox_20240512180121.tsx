...
<input
    onChange={e => {
        let newItem: OrderType = { ...(itemsShow || {}) };
        newItem.isPay = newItem.isPay || {}; // Ensure isPay exists
        newItem.isPay.isPaid = e.target.checked; // Assuming e.target.checked represents the new value for isPaid
