'use client'
import { AddListOrder, UpdateOrder } from "@/app/redux/features/order/order.redux";
import { useAppDispatch, useAppSelector } from "@/app/redux/hooks";
import { getAllOrderApi, getProductByIdApi, getTopProductApi, makeRequestApi, updateOrderApi } from "@/lib/api";
                ...
                {listOrder?.map((orderData, index) => (
                    <div key={orderData?.id} className="w-full my-4 max-w-7xl px-4 md:px-5 lg-6 mx-auto">
                        <div className="col-span-2 flex items-center gap-1">
                            <div onClick={() => handleShow(orderData, "my_modal_edit")} className="btn btn-info">
                                Get Bill
                            </div>
