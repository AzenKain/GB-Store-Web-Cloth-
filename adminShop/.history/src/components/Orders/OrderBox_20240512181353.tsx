                    ...
                    <div key={orderData?.id} className="w-full my-4 max-w-7xl px-4 md:px-5 lg-6 mx-auto">
                        <div className="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                            <div className="flex flex-col lg:flex-row lg:items-center justify-between px-6 pb-6 border-b border-gray-200">
                                ...
                                <div onClick={() => handleShow(orderData, "my_modal_edit")} className="text-center cursor-pointer text-3xl border-yellow-500 font-bold text-black dark:text-white border-4 bg-green-500 px-4 py-2 rounded-full">
                                    Edit
                                </div>
                            </div>
            ...
            <dialog id="my_modal_edit" className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    ...
                    <div className="flex flex-col">
                        <h3 className="font-semibold text-3xl">Edit Order</h3>
                        ...
                        <div className="">
                            ...
                            <div className="relative z-20 bg-transparent dark:bg-form-input">
                                <select
                                    ...
                                    className={`relative z-20 w-full appearance-none rounded border border-stroke bg-transparent px-5 py-3 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary ${orderStatus? "text-black dark:text-white" : ""
                                        }`}
                                >
                                    {elementSelect.element.map((item, index) => (
                                        <option key={index} value={item} className="label-text text-xl">
                                            {item}
                                        </option>
                                    ))}
                                </select>
