        ...
        {productList.map((product, key) => (
          ...
          >
            ...
            <div className="col-span-2 flex items-center gap-1">
              ...
              <button aria-label="Submit" onClick={() => handleShow(-1, "my_modal_view", "VIEW")} className="btn btn-info">
              ...
              <div>
                ...
                <div>
                  {productList[productSelect]?.imgDisplay.map((image, index) => (
                    <Image key={index} src={image?.url} alt={`Product Image ${index + 1}`} style={{ maxWidth: '200px' }} />
                  ))}
                </div>
