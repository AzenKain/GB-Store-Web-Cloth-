          ...
          >
            ...
            <dialog id="my_modal_view" className="modal">
                <div className="modal-box w-11/12 max-w-5xl">
                    ...
                    <div>
                      {product.imgDisplay.map((image, index) => (
                        <img key={index} src={image.url} alt={`Product Image ${index + 1}`} style={{ maxWidth: '200px' }} />
                      ))}
                    </div>
                    <h3>Product Details:</h3>
                    <ul>
                      <li>Tags: {product.detail?.tags.join(', ')}</li>
                      <li>Company: {product.detail?.company}</li>
                      <li>Materials: {product.detail?.materials.join(', ')}</li>
                    </ul>
                    {product.sales && (
                      <div>
