...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const productList = useAppSelector((state) => state.UserRedux.value)
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("messages") && "bg-graydark dark:bg-meta-4"
                    }`}
                >
          ...
          {/* <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5"> */}
              ...
              {/* <SidebarLinkGroup
                activeCondition={pathname === "/dashboard/ui" || pathname.includes("ui")}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
