          ...
          <div className="my-4 max-w-screen-md border px-4 shadow-xl sm:mx-4 sm:rounded-xl sm:px-4 sm:py-4 md:mx-auto ">
            ...
            <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
              ...
              <input
                ...
                className="w-full rounded-md border text-black dark:text-white bg-white px-2 py-2 outline-none ring-blue-600 focus:ring-1"
              />
            </div>
            <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
            ...
            <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
              ...
              <input
                ...
                className="mb-2 w-full rounded-md border text-black dark:text-white bg-white px-2 py-2 outline-none ring-blue-600 sm:mr-4 sm:mb-0 focus:ring-1"
              />
              <input
                value={lastName}
            ...
            <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
              ...
              <input
                ...
                type="text"
                placeholder="Address"
                className="w-full rounded-md bordertext-black dark:text-white  bg-white px-2 py-2 outline-none ring-blue-600 focus:ring-1"
              />
            </div>
            <div className="flex flex-col gap-4 border-b py-4 sm:flex-row">
