      ...
      <div className="mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8">
          <div className="my-4 max-w-screen-md border px-4 shadow-xl sm:mx-4 sm:rounded-xl sm:px-4 sm:py-4 md:mx-auto ">
            ...
            <div className="flex flex-col gap-4 border-b py-4 sm:flex-row text-black dark:text-white border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
